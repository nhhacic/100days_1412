...
import { 
  ...
  ArrowRight, LogIn, UserPlus, Shield, Zap, Waves,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-green-500 text-white py-8 px-4 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="inline-flex items-center justify-center w-24 h-24 bg-white/20 rounded-full mb-4 p-2">
            ...
            {/* Fallback: Hiển thị Trophy nếu logo không load được */}
            {logoError && (
              <Trophy className="w-16 h-16" />
            )}
            
            {/* CÁCH 2: Dùng logo từ URL */}
            {/* 
            <img 
              ...
              style={{ display: logoError ? 'none' : 'block' }}
            />
            {logoError && <Trophy className="w-16 h-16" />}
            */}
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center mt-4 space-y-2 md:space-y-0 md:space-x-8">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-2xl p-6">
            <div className="flex items-center mb-4">
              <Flag className="w-6 h-6 text-blue-600 mr-3" />
              <h2 className="text-xl font-bold text-blue-800">🏁 Tổng quan thử thách</h2>
            </div>
            
            {/* Timeline */}
            <div className="mb-6">
              <h3 className="font-bold text-gray-900 mb-3">📅 Timeline chính xác</h3>
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 border border-blue-100">
                  <div className="flex items-center mb-2">
                    <div className="w-3 h-3 rounded-full bg-blue-600 mr-2"></div>
                    <span className="font-bold text-blue-700">{config.durationMonths || 3} THÁNG KPI</span>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-white rounded-lg p-4 border border-blue-100">
                <div className="flex items-center mb-3">
                  <div className="w-3 h-3 rounded-full bg-blue-600 mr-2"></div>
                  <span className="font-bold text-gray-900 text-lg">Nam</span>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 border-t-4 border-orange-500">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900">🏥 Chấn thương</h2>
              </div>
              <div className="space-y-3">
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-700">
                    Nếu bị chấn thương không bơi/chạy được: báo với <strong>{config.admin.name}</strong> để được miễn giảm KPI.
                  </p>
                </div>
                <div className="flex items-start">
                  <AlertCircle className="w-5 h-5 text-orange-500 mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-700">
                    <strong>Đề cao tính trung thực</strong> và cần có chứng minh chấn thương.
                  </p>
                </div>
                <div className="flex items-start">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-green-50 border-2 border-blue-200 rounded-2xl p-8 mb-8">
          ...
          <div className="flex items-start justify-center mb-8">
            <input
              ...
              className="mt-1 mr-3 w-6 h-6 text-blue-600 rounded focus:ring-blue-500"
            />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={handleJoin}
              disabled={!accepted}
              className={`px-8 py-4 rounded-xl font-bold text-lg transition-all flex items-center justify-center ${
                accepted 
            ...
            >
              ...
              {accepted ? 'TÔI ĐÃ SẴN SÀNG - THAM GIA NGAY' : 'VUI LÒNG ĐỌC VÀ ĐỒNG Ý QUY TẮC'}
              <ArrowRight className="w-6 h-6 ml-2" />
            </button>

            <button
              onClick={handleLogin}
              className="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-xl font-bold text-lg hover:opacity-90 transition shadow-lg flex items-center justify-center hover:scale-105 transform"
            >
              <LogIn className="w-6 h-6 mr-2" />
              ĐĂNG NHẬP (Đã tham gia các mùa trước)
            </button>
          </div>
